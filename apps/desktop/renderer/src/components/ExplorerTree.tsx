...
const explorerNodes: ExplorerGroup[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'rpt-a01', label: 'Voucher Register', route: '/app/reports/RPT-A01', permission: { resource: 'reports', action: PermissionAction.READ } },
      { id: 'rpt-a02', label: 'Cash Book', route: '/app/reports/RPT-A02', permission: { resource: 'reports', action: PermissionAction.READ } },
      { id: 'rpt-a03', label: 'Bank Book', route: '/app/reports/RPT-A03', permission: { resource: 'reports', action: PermissionAction.READ } },
      { id: 'rpt-a04', label: 'General Ledger', route: '/app/reports/RPT-A04', permission: { resource: 'reports', action: PermissionAction.READ } },
      { id: 'rpt-a05', label: 'Trial Balance', route: '/app/reports/RPT-A05', permission: { resource: 'reports', action: PermissionAction.READ } },
      { id: 'rpt-a06', label: 'Balance Sheet', route: '/app/reports/RPT-A06', permission: { resource: 'reports', action: PermissionAction.READ } },
      { id: 'rpt-a07', label: 'Income & Expenditure', route: '/app/reports/RPT-A07', permission: { resource: 'reports', action: PermissionAction.READ } },
      { id: 'rpt-a08', label: 'Receipt & Payment', route: '/app/reports/RPT-A08', permission: { resource: 'reports', action: PermissionAction.READ } },
      { id: 'rpt-a09', label: 'Bank Reconciliation Stmt', route: '/app/reports/RPT-A09', permission: { resource: 'reports', action: PermissionAction.READ } },
  ...
  },
  {
    ...
    children: [
      { id: 'view-b07', label: 'Member Outstanding', route: '/app/reports/RPT-B07', permission: { resource: 'reports', action: PermissionAction.READ } },
      { id: 'view-a01', label: 'Voucher Register', route: '/app/reports/RPT-A01', permission: { resource: 'reports', action: PermissionAction.READ } },
      { id: 'view-a04', label: 'General Ledger', route: '/app/reports/RPT-A04', permission: { resource: 'reports', action: PermissionAction.READ } },
      { id: 'view-b01', label: 'Bill Register', route: '/app/reports/RPT-B01', permission: { resource: 'reports', action: PermissionAction.READ } },
    ],
  },
];
