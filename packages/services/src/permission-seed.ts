...
const MATRIX: MatrixEntry[] = [
  ...
  {
    resource: RESOURCES.ADMIN_USERS,
    admin: [PermissionAction.CREATE, PermissionAction.READ, PermissionAction.UPDATE, PermissionAction.DELETE],
    accountant: [],
    operator: [],
    committee: [],
  ...
  {
    resource: RESOURCES.ADMIN_BACKUP,
    admin: [PermissionAction.CREATE, PermissionAction.READ, PermissionAction.UPDATE, PermissionAction.DELETE],
    accountant: [PermissionAction.READ],
    operator: [],
    committee: [],
  ...
  {
    resource: RESOURCES.ADMIN_AUDIT,
    admin: [PermissionAction.READ, PermissionAction.EXPORT],
    accountant: [PermissionAction.READ, PermissionAction.EXPORT],
    operator: [],
    committee: [],
    auditor: [PermissionAction.READ, PermissionAction.EXPORT],
  },
  {
  ...
  },
  {
    ...
    admin: [PermissionAction.READ, PermissionAction.EXPORT, PermissionAction.PRINT],
    accountant: [PermissionAction.READ, PermissionAction.EXPORT, PermissionAction.PRINT],
    operator: [PermissionAction.READ],
    committee: [PermissionAction.READ],
    auditor: [PermissionAction.READ],
  },
  {
    ...
    admin: [PermissionAction.READ, PermissionAction.UPDATE],
    accountant: [PermissionAction.READ, PermissionAction.UPDATE],
    operator: [PermissionAction.READ, PermissionAction.UPDATE],
    committee: [PermissionAction.READ, PermissionAction.UPDATE],
    auditor: [PermissionAction.READ],
  },
  {
    resource: RESOURCES.STARTUP,
    admin: [PermissionAction.READ, PermissionAction.CREATE],
    accountant: [PermissionAction.READ],
    operator: [],
    committee: [],
    auditor: [],
